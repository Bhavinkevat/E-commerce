...
from app.schemas.admin import AnalyticsMetric, CustomerSummary, DashboardResponse
from app.schemas.order import OrderRead
from app.services.admin import build_analytics, build_customer_summaries, build_dashboard_cards
from app.services.order import attach_order_items, list_orders_for_admin
